...
public class IZHEVSK {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[][] courses = {{"post-5429", "20240307"}, // Python для веба
        ...
        for (int i = 0; i < courses.length; i++) {
            ...
            WebElement date = driver.findElement(By.xpath("//*[@id=\"acf-field_5bfbf230649f6\"]"));
            jse.executeScript("arguments[0].value='" + courses[i][1] + "'", date);
            Thread.sleep(1000);
