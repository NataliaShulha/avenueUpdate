...
public class Main60 {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[][] cities = {
                {"belgorod", "//*[@id=\"acf-field_62b1f2ccf02d4\"]"},
                {"surgut", "//*[@id=\"acf-field_62b1f2ccf02d4\"]"},
                {"vladimir", "//*[@id=\"acf-field_62b1f2ccf02d4\"]"},
                {"n-tagil", "//*[@id=\"acf-field_62b1f2ccf02d4\"]"},
                {"chita", "//*[@id=\"acf-field_62b1f2ccf02d4\"]"},
                {"podolsk", "//*[@id=\"acf-field_62b1f2ccf02d4\"]"},
                {"arkhangelsk", "//*[@id=\"acf-field_62b1f2ccf02d4\"]"},
                {"simferopol", "//*[@id=\"acf-field_62b1f2ccf02d4\"]"},
                {"kaluga", "//*[@id=\"acf-field_62b1f2ccf02d4\"]"},
                {"grozny", "//*[@id=\"acf-field_62b1f2ccf02d4\"]"},
