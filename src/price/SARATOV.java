...
public class SARATOV {
    public static void main(String[] args) throws InterruptedException {
        int priceMonthOchno = 8628; // очно
        int priceMonthOnline = 7803; // онлайн
        int priceMonthVidep = 6908; // видео

        int oldPriceOchno = 23320; // старая цена Очно
        int oldPriceOnline = 21090; // старая цена Онлайн
        int oldPriceVideo = 18670; // старая цена Видео

        String monthPriceOznoStr = "Данный пакет можно приобрести в рассрочку БЕЗ банка по 10 490 руб./мес."; // очно
        String monthPriceOnlineStr = "Данный пакет можно приобрести в рассрочку БЕЗ банка по 9 490 руб./мес."; // онлайн
        String monthPriceVideoStr = "Данный пакет можно приобрести в рассрочку БЕЗ банка по 8 490 руб./мес."; // видео

        String[][] courses = {{"post-5429", "4"}, // Python для веба
        ...
        // логин в админку
        driver.get("https://saratov.avenue.school/wp-admin/edit.php?post_type=course");
        ...
        Thread.sleep(1000);
        WebElement strOchnoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7f8320b7f\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOznoStr + "'", strOchnoPriceElem);
        WebElement strOnlinePriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7f7120b7e\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOnlineStr + "'", strOnlinePriceElem);
        WebElement strVideoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7f8a20b80\"]"));
