...
public class NN {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[][] courses = {{"post-5435", "4"}, // Python для веба
        ...
        // логин в админку
        driver.get("https://nn.avenue.school/wp-admin/edit.php?post_type=course");
        ...
        Thread.sleep(1000);
        WebElement strOchnoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c777aa2d92\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOznoStr + "'", strOchnoPriceElem);
        WebElement strOnlinePriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c775bf6ac4\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOnlineStr + "'", strOnlinePriceElem);
        WebElement strVideoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7786a2d93\"]"));
