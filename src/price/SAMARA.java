...
public class SAMARA {
    public static void main(String[] args) throws InterruptedException {
        ...
        // логин в админку
        driver.get("https://samara.avenue.school/wp-admin/edit.php?post_type=course");
        ...
        Thread.sleep(1000);
        WebElement strOchnoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7bb19790d\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOznoStr + "'", strOchnoPriceElem);
        WebElement strOnlinePriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7b979790c\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOnlineStr + "'", strOnlinePriceElem);
        WebElement strVideoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7bb99790e\"]"));
