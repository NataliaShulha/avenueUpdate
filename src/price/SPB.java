...
public class SPB {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[][] courses = {{"post-5450", "4"}, // Python для веба
        ...
        // логин в админку
        driver.get("https://spb.avenue.school/wp-admin/edit.php?post_type=course");
        ...
        Thread.sleep(1000);
        WebElement strOchnoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c76a8850ba\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOznoStr + "'", strOchnoPriceElem);
        WebElement strOnlinePriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c768d09785\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOnlineStr + "'", strOnlinePriceElem);
        WebElement strVideoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c76b6933d9\"]"));
