...
public class VRN {
    public static void main(String[] args) throws InterruptedException {
        ...
        String monthPriceVideoStr = "Данный пакет можно приобрести в рассрочку БЕЗ банка по 8я 490 руб./мес."; // видео

        String[][] courses = {{"post-5428", "4"}, // Python для веба
        ...
        Thread.sleep(1000);
        WebElement strOchnoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7abe0c367\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOznoStr + "'", strOchnoPriceElem);
        WebElement strOnlinePriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7aad0c366\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOnlineStr + "'", strOnlinePriceElem);
        WebElement strVideoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7ac60c368\"]"));
