...
public class MSK {
    public static void main(String[] args) throws InterruptedException {
        int priceMonthOchno = 9861 ; // очно
        int priceMonthOnline = 9039; // онлайн
        int priceMonthVidep = 8214; // видео

        int oldPriceOchno = 26650; // старая цена Очно
        int oldPriceOnline = 24430; // старая цена Онлайн
        int oldPriceVideo = 22200; // старая цена Видео

        String monthPriceOznoStr = "Данный пакет можно приобрести в рассрочку БЕЗ банка по 11 990 руб./мес."; // очно
        String monthPriceOnlineStr = "Данный пакет можно приобрести в рассрочку БЕЗ банка по 10 990 руб./мес."; // онлайн
        String monthPriceVideoStr = "Данный пакет можно приобрести в рассрочку БЕЗ банка по 9 990 руб./мес."; // видео

        String[][] courses = {{"post-5457", "4"}, // Python для веба
        ...
        // логин в админку
        driver.get("https://msk.avenue.school/wp-admin/edit.php?post_type=course");
        ...
        Thread.sleep(1000);
        WebElement strOchnoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c750747a6c\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOznoStr + "'", strOchnoPriceElem);
        WebElement strOnlinePriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c6b6063f96\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOnlineStr + "'", strOnlinePriceElem);
        WebElement strVideoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7514a20dc\"]"));
