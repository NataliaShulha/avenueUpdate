...
public class IZHEVSK {
    public static void main(String[] args) throws InterruptedException {
        int priceMonthOchno = 8214; // очно
        int priceMonthOnline = 7393; // онлайн
        int priceMonthVidep = 6571; // видео

        int oldPriceOchno = 22200; // старая цена Очно
        int oldPriceOnline = 19980; // старая цена Онлайн
        int oldPriceVideo = 17760; // старая цена Видео

        String monthPriceOznoStr = "Данный пакет можно приобрести в рассрочку БЕЗ банка по 9 990 руб./мес."; // очно
        String monthPriceOnlineStr = "Данный пакет можно приобрести в рассрочку БЕЗ банка по 8 990 руб./мес."; // онлайн
        String monthPriceVideoStr = "Данный пакет можно приобрести в рассрочку БЕЗ банка по 7 990 руб./мес."; // видео
        ...
        // логин в админку
        driver.get("https://izhevsk.avenue.school/wp-admin/edit.php?post_type=course");
        ...
        Thread.sleep(1000);
        WebElement strOchnoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7d77a9468\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOznoStr + "'", strOchnoPriceElem);
        WebElement strOnlinePriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7d66a9467\"]"));
        jse.executeScript("arguments[0].value='" + monthPriceOnlineStr + "'", strOnlinePriceElem);
        WebElement strVideoPriceElem = driver.findElement(By.xpath("//*[@id=\"acf-field_614c7d7da9469\"]"));
